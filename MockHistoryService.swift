...
public class MockHistoryService: HistoryService {
    ...
    private let sendTx = HistoryTransaction(
        txSignature: "4WhwUsyNci7DmV9QA3hTQZsysX4f9YvaVo6HUWR2QejomcSaZbhacSfvB9we4dthhx8dwfLrWgR9tNtvjKHSYV6F",
        date: Date(),
        status: .success,
        type: .send,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.005", payer: "Fy7WgQxZLu4eL6ejpFbwARUiTTRH13Ag1akzaoESozuA", tokenPrice: "1")])
    )

    private let receiveTx = HistoryTransaction(
        txSignature: "3cRnZPCnGwBc5Y9KPW2brni2SCnbo7QhmYwSCEKyEMBMagVjxiGo1LXJSQb55rfQzvHRMACnTbAiZQvosg6f42d7",
        date: Date(),
        status: .success,
        type: .receive,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.005", payer: "3f1jB3pieiLw1XstjrAG5pRC1xGaF3XTpjmhNMMmyGJA", tokenPrice: "1")])
    )

    private let swapTx = HistoryTransaction(
        txSignature: "3f2NjDiyqPLXudcmacW44cmnvCg4pakSLjK5xe2cieSpHaU5G1fQ3MwUGtw5z59LJaKYjPVmkeDR8Pt8kdJTYiay",
        date: Date(),
        status: .success,
        type: .swap,
        info: .init(
    ...
    private let stakeTx = HistoryTransaction(
        txSignature: "evMmjayyY4MKWEdCbU152c3iqKBwmG6gZSNoFesQqLmX7UCZxBjKTX5n3xoHnyi1Z82FfJXvXeJDkjNgqnbUb6c",
        date: Date(),
        status: .success,
        type: .stake,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.005", payer: "GccETn3yYfwVmgmfvcggsEAUKd5zqFTiKF5skj2bGYU7", tokenPrice: "1")],
            voteAccount: .init(name: nil, address: "FKsC411dik9ktS6xPADxs4Fk2SCENvAiuccQHLAPndvk")
        )
    )

    private let unstakeTx = HistoryTransaction(
        txSignature: "29NY9Yxw911JwY9q4dC5DPgQpMoH5XFX5taGDHGRLmFZqN8UPRbJj719uKpwd6BcVepKZh6GVMdMahY3ogK9s3eK",
        date: Date(),
        status: .success,
        type: .unstake,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.000005", payer: "GccETn3yYfwVmgmfvcggsEAUKd5zqFTiKF5skj2bGYU7", tokenPrice: "1")],
            voteAccount: .init(name: nil, address: "FKsC411dik9ktS6xPADxs4Fk2SCENvAiuccQHLAPndvk")
        )
    )

    private let createAccountTx = HistoryTransaction(
        txSignature: "4dNta5EG7ajGtLGQtdDRARircc4e1HCibcF95GrHM3Wi5eah1eqt1Xco99KY7i8sR3j8tDrgp4ZVV7DzTTGGLB4m",
        date: Date(),
        status: .success,
        type: .createAccount,
        info: .init(
    ...
    private let closeAccountTx = HistoryTransaction(
        txSignature: "3fPGdk93gM1mp7jj8B8vqE8K3Y6cEi4uRNuenKYcVrUDnu1ZSNvxvHEPtWAJqRkH8bSqJRmLLrRwUyk3zRhChSEh",
        date: Date(),
        status: .success,
        type: .closeAccount,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.000005", payer: "3f1jB3pieiLw1XstjrAG5pRC1xGaF3XTpjmhNMMmyGJA", tokenPrice: "1")]
        )
    )

    private let burnTx = HistoryTransaction(
        txSignature: "3gVo7ePp1CRktcfFca9SyePXLvGZzMDjeV63BkPVnRAxKVeRKZN6xPJgfK4Ny2c4yRKDyxU9hD8gXuPWABVVb9iA",
        date: Date(),
        status: .success,
        type: .burn,
        info: .init(
            ...
            fee: [.init(type: "transaction", amount: "0.000015", payer: "3f1jB3pieiLw1XstjrAG5pRC1xGaF3XTpjmhNMMmyGJA", tokenPrice: "1")]
        )
    )

...
/**
 * IOS interface for calling [p2p_sdk::api::nonblocking::get_solend_collateral_accounts]
 */
char *get_solend_collateral_accounts(const char *rpc_url, const char *owner);

/**
 * IOS interface for calling [p2p_sdk::api::nonblocking::get_solend_market_info]
 */
char *get_solend_market_info(const char *tokens, const char *pool);

/**
 * IOS interface for calling [p2p_sdk::api::nonblocking::get_solend_user_deposits]
 */
char *get_solend_user_deposits(const char *owner, const char *pool);

/**
 * IOS interface for calling [p2p_sdk::api::nonblocking::get_solend_user_deposit_by_symbol]
 */
